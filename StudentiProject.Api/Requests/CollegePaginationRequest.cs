...
{
    public class CollegePaginationRequest : AbstractPagingRequest<CollegeResponse>
    {
        ...
        public override IQueryable<CollegeResponse> GetFilteredQuery(IQueryable<CollegeResponse> query)
        {
        ...
        public override IQueryable<CollegeResponse> SetUpSorting(IQueryable<CollegeResponse> query)
        {
